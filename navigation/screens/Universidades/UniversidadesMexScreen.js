...
const UniversidadesMexScreen = ({navigation}) => {
    ...
    <View>
      <ScrollView>
        ...
        >
          ...
          <Card.Actions>
            <Button
              onPress={() => navigation.navigate("Universidad1Mex")}
              style={{ width: "100%" }}
            >
        ...
        >
          <Title style={{ textAlign: "center", margin: 5 }}>
          Universiadad Popular Autonoma Del Estado De Puebla
          </Title>
          <Card.Cover
            source={{
          ...
          <Card.Actions>
            <Button
              onPress={() =>
                navigation.navigate("Universidad2Mex")
              }
              style={{ width: "100%" }}
            >
              <Text style={{ color: "#EE627E", textAlign: "center" }}>Ver</Text>
        ...
        >
          ...
          <Card.Actions>
            <Button
              onPress={() =>
                navigation.navigate("Universidad3Mex")
              }
              style={{ width: "100%" }}
            >
              <Text style={{ color: "#EE627E", textAlign: "center" }}>Ver</Text>
...
export default UniversidadesMexScreen